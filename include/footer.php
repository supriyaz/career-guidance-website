                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="footer-bottom">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <p>Copyright © <?= date('Y') ?> <span style="color: #29aafe; font-weight: bold;"><?= $details['business_name']; ?>.</span>. All Right Reserved. <a href="http://localhost/Online-Career-Guidance-master/admin/">Admin</a></p>
